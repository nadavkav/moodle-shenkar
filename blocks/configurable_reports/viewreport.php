...
//            echo '<div id="weizmanndavidsonlogo" ><img src="'.$OUTPUT->image_url('reports/logos', 'block_configurable_reports').'"></div>';
//            echo '<div id="weizmannlogosfull" ><img src="'.$OUTPUT->image_url('reports/logosfull', 'theme').'"></div>';
    ...
    if ($printreport) {   //  nadavkav 25/3/14
        echo '<div id="footerlogo"><img src="'.$OUTPUT->image_url('reports/footer', 'block_configurable_reports').'"></div>';
    }