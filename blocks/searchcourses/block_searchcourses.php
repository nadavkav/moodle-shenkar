...
class block_searchcourses extends block_base
{
    ...
    public function get_content()
    {
        ...
        if (has_capability('moodle/site:config', context_system::instance())) {
            $form_html .= "<div id=\"my_courses_container\"><label for = \"my_courses_flag\">".get_string('mycourses')."</label>" .
                "<input type=\"checkbox\" id=\"my_courses_flag\"  name=\"my_courses_flag\" value=\"0\"/></div>";
        } else {
            $form_html .= "<input type=\"hidden\" id=\"my_courses_flag\"  name=\"my_courses_flag\" value=\"1\"/>";
        }
